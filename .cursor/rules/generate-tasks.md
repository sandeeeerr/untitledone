...
7.  **Identify Relevant Files:** Based on the tasks and PRD, identify potential files that will need to be created or modified. List these under the `Relevant Files` section.
...
- Keep this list scoped to files likely to be created or modified.
- Include only files relevant to implementing and integrating the feature.
